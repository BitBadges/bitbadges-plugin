...
```bash
bitbadges-cli sdk address convert <address> --to <bb1|0x>
bitbadges-cli sdk address validate <address>
```
...
| Need | Command |
|---|---|
| Backing address for an IBC denom (smart-token deposits) | `bitbadges-cli sdk alias for-ibc-backing <denom>` |
| Wrapper address for a collection | `bitbadges-cli sdk alias for-wrapper <collection-id>` |
| Mint-escrow address for a collection | `bitbadges-cli sdk alias for-mint-escrow <collection-id>` |
